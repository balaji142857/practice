...
public class Test {
	...
	/*public static void main(String[] args) {LocalDate currentDate = LocalDate.now();
	...
	// using offsets
	 LocalDateTime tdate = LocalDateTime.of(2013, Month.JULY, 20, 3, 30);
	ZoneOffset offset = ZoneOffset.of("+05:00");
	 
	// 2013-07-20 03:30 +05:00
	OffsetDateTime plusFive = OffsetDateTime.of(tdate, offset);
