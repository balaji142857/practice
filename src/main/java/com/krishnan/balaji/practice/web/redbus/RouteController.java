...
public class RouteController {
	...
	@PostMapping("confirm")
	public ModelAndView hadleNewRouteValidation(@PathVariable long operatorId,
			@Valid Route route, 
		...
		if (result.hasErrors()) {
			...
			for(ObjectError error: result.getAllErrors()){
				log.error("errorInNewRoute: "+error.getObjectName()+":"+error.getCode()+":"+error.getDefaultMessage());
			}
	...
	@PostMapping("new")
	public ModelAndView handleNewRouteRequest(HttpSession session,
