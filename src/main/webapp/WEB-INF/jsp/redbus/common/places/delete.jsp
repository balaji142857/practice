...
<body>
	...
	<c:url value="/redbus/places/${placeToDelete.id}/delete" var="confirmURL"/>		
	
	<div class="container">
		<form:form action="${confirmURL}" method="post" modelAttribute="placeToDelete" class="form-horizontal">
			<form:hidden  path="id"/>			
